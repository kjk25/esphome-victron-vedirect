...
#define REGISTERS_COMMON(MACRO) \
  ...
  MACRO(ANY, NUMERIC, 0xEDF0, BAT_MAX_CUR_SET, READ_WRITE, uint16_t, A, S_0_1, S_0_1) \
  MACRO(ANY, NUMERIC, 0x2015, BAT_MAX_CUR_SET_TMP, READ_WRITE, uint16_t, A, S_0_1, S_0_1) \
